...
This package is known to be compatible with versions of Octave v3.8.4+ and Matlab v7.4.0+. It may also be compatible with some earlier versions of Octave but earlier versions have not been tested. 
